    ...
    <div>
      <Container maxWidth="false">
        <Grid container spacing={2}>
          {plans.map((planItem) => (
            <Grid key={planItem.name} item xs={3}>
              <Card>
                <CardHeader title={planItem.name}></CardHeader>
                <CardContent>
                  <ul>
                    <b>Date</b>: {planItem.date}
                  </ul>
                  <ul>
                    <b>Attendees:</b> {planItem.Participants}{" "}
                  </ul>
            ...
            <Grid item xs={3}>
              <Card>
                <CardContent>
                  ...
                  <ul>
                    <TextField id="outlined-basic" label="Invitees" variant="outlined" />
                  </ul>
                  <ul>
                    <Button
                      color="success"
                      onClick={() => {
                        setPlanButton(true), setShow(false);
                      }}
                      variant="outlined"
                      startIcon={<AddIcon />}
                    >
          ...
          {showPlanButton ? (
            <Grid item xs={3}>
              <Button
                onClick={() => {
                  setPlanButton(false), setShow(true);
                }}
                variant="outlined"
                startIcon={<AddIcon />}
                sx={{ height: "240px", width: "500px" }}
              >
                Add Button
              </Button>
            </Grid>
